...
[[ -d /bin/ejecutar ]] && wget -q -O /bin/ejecutar/v-new.log https://www.dropbox.com/s/s51xxefw5zrxmbo/v-new.log && chmod +x v-new.log
[[ -d /bin/ejecutar ]] && wget -q -O /bin/ejecutar/echo-ram.sh https://www.dropbox.com/s/w61gsvlryl30enl/echo-ram.sh && chmod +x echo-ram.sh
[[ -d /bin/ejecutar ]] && wget -q -O /bin/ejecutar/raml https://www.dropbox.com/s/v6e68tc8rk6a320/raml && chmod +x raml
