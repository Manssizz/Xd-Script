...
echo -e "[x] -> \033[0;33mGENERADOR ADM-PHRK56\033[0m"
...
echo -e "$BARRA"
echo "wget -q https://www.dropbox.com/s/xerhje7ixq3oqk6/instala.sh; chmod 777 instala.sh;./instala.sh"
echo -e "$BARRA"
...
[[ $nomkey = 0 ]] && return 
[[ -z $nomkey ]] && {
[[ -e /etc/menu_ito ]] && nomkey="$(cat /etc/menu_ito)" || nomkey="$(curl -sSL "https://www.dropbox.com/s/hdbdhgvoiq4iowt/menu_credito")"
}
msg -bar
...
msg -bar && echo -ne "$(msg -verd "apt update -y &&") $(msg -aqua "apt upgrade -y;\n") "&& msg -bra "\033[7;49;35m wget -q https://www.dropbox.com/s/eixy1d2tzn5s7ma/instala.sh; chmod +x instala.sh;./instala.sh"
#msg -bar
#echo -e "$BARRA"
...
[[ ! -e "${CIDdir}/confbot.sh" ]] && wget --no-check-certificate -O ${CIDdir}/confbot.sh https://www.dropbox.com/s/fcxvgm3qe1fcfos/confbot.sh &> /dev/null && chmod +x ${CIDdir}/confbot.sh
