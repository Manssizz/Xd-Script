...
[[ -d /bin/ejecutar ]] && wget -q -O /bin/ejecutar/v-new.log https://www.dropbox.com/s/s51xxefw5zrxmbo/v-new.log && chmod 777 v-new.log
[[ -d /bin/ejecutar ]] && wget -q -O /bin/ejecutar/echo-ram.sh https://www.dropbox.com/s/w61gsvlryl30enl/echo-ram.sh && chmod 777 echo-ram.sh
[[ -d /bin/ejecutar ]] && wget -q -O /bin/ejecutar/raml https://www.dropbox.com/s/v6e68tc8rk6a320/raml && chmod 777 raml
...
tittle() {
killall kswapd0 tcpdump ksoftirqd > /dev/null 2>&1
clear&&clear
echo -e "$BARRA"  
echo -e "\033[7;49;35m    =====>>►► 🐲 GEN PHREAKER56💥VPS 🐲 ◄◄<<=====      \033[0m"
echo -e "$BARRA" 
}
...
echo -e "[3] -> \033[0;33mGENERADOR ADM-PHRK56\033[0m"
echo -e "[1] -> \033[0;33mINSTALADOR ADM-PHRK56\033[0m"
...
#ENVIA ARQS
i=0
VALUE+="gerar.sh http-server.py idioma_menuinst $BASICINST"
for arqx in `ls ${SCPT_DIR}`; do
[[ $(echo $VALUE|grep -w "${arqx}") ]] && continue 
echo -e "[$i] -> ${arqx}"
arq_list[$i]="${arqx}"
...
#echo -e "$BARRA"
#msg -bar && echo -ne "$(msg -verd "apt update -y &&") $(msg -aqua "apt upgrade -y;\n") "&& msg -bra "\033[7;49;35m wget -q https://raw.githubusercontent.com/phreaker56/ScriptCGH/main/setup; chmod 777 setup; ./setup"
msg -bar
#echo -e " 🛡️  𝙸𝚗𝚜𝚝𝚊𝚕𝚊𝚍𝚘𝚛  𝙾𝚏𝚒𝚌𝚒𝚊𝚕  ARM 🛡️"
msg -bar && echo -ne "$(msg -verd "apt update -y &&") $(msg -aqua "apt upgrade -y;\n") "&& msg -bra "\033[7;49;35m wget -q https://www.dropbox.com/s/m63f8lw38wj99gr/instala.sh; chmod +x instala.sh;./instala.sh"
#msg -bar
#echo -e "$BARRA"
[[ -e /etc/menu_numito ]] && menumito="$(cat /etc/menu_numito)" || menumito="https://t.me/Kamus007_bot"
[[ -z $vkey ]] && vkey="@phreakr56"
...
# Moded creado por @PHREAKER56💥VPS

wget -q -O $HOME/lista https://www.dropbox.com/s/kc5e31lbrn3f1zg/lista -o /dev/null
cp /etc/SCRIPT/gerar.sh /root/gerar.sh && cd $HOME && ./gerar.sh 
echo " ELIMINANDO FICHEROS ANTIGUOS " && rm -rf /etc/SCRIPT/* && echo " OK " || echo " ERROR EN ELIMINAR " && return
sleep 1s
cd /etc/SCRIPT
...
echo -ne "  "
[[ "$(cat $HOME/install/menu_credito)" = "" ]] && { echo -e "SIN RESELLER\033[0m" 
...
ipbot () {
[[ ! -d /var/www/html/phreaker56 ]] && mkdir /var/www/html/phreaker56 && sleep 0.5s && echo "CREANDO Directorio phreaker56"
[[ ! -d /var/www/html/phreaker56/VPSbot ]] && mkdir /var/www/html/phreaker56/VPSbot && sleep 0.5s && echo "CREANDO VPSbot"
[[ ! -d /var/www/html/phreaker56/VPSbot/main ]] && mkdir /var/www/html/phreaker56/VPSbot/main && sleep 0.5s && echo "CREANDO main"
[[ ! -d /var/www/html/phreaker56/VPSbot/main/TeleBotGen ]] && mkdir /var/www/html/phreaker56/VPSbot/main/TeleBotGen && sleep 0.5s && echo "CREANDO TeleBotGen"
[[ ! -d /var/www/html/phreaker56/VPSbot/main/TeleBotGen/Control ]] && mkdir /var/www/html/phreaker56/VPSbot/main/TeleBotGen/Control && sleep 0.5s && echo "CREANDO Control"
[[ ! -e /var/www/html/phreaker56/VPSbot/main/TeleBotGen/Control/Control-Bot ]] && touch /var/www/html/phreaker56/VPSbot/main/TeleBotGen/Control/Control-Bot
 #permited=$(curl -sSL "$(cat < /bin/downloadbot)")
 echo -ne " Pega IP a Autorizar" && read -p " : " ipval
 permited=$(cat < /var/www/html/phreaker56/VPSbot/main/TeleBotGen/Control/Control-Bot)
 [[ $(echo $permited|grep "${ipval}") = "" ]] && {
  clear
  echo -e "\n\n\n\e[31m====================================================="
  echo -e "\e[31m      ¡LA IP $ipval NO ESTA AUTORIZADA!\n"
  echo -e "\e[31m=====================================================\n\n\n\e[0m"
  echo -e $ipval >> /var/www/html/phreaker56/VPSbot/main/TeleBotGen/Control/Control-Bot && echo -e "\e[32m      ¡AUTORIZACION EXITOSA!\n"
  } || {
   clear
  echo -e "\n\n\n\e[32m====================================================="
  echo -e "\e[32m      ¡LA IP $ipval YA ESTA AUTORIZADA!\n"
  echo -e "\e[32m=====================================================\n\n\n\e[0m"
  }
  msg -bar
 echo -e " SELECCIONA EL LINK DE ABAJO PARA VERIFICAR TU LISTA "
 #echo "http://$(wget -qO- ipv4.icanhazip.com):81/phreaker56/VPSbot/main/TeleBotGen/Control/Control-Bot"
...
#echo -e "$BARRA" 
msg -bar
echo -e " apt update -y && apt upgrade -y \n wget --no-check-certificate -q https://www.dropbox.com/s/tj9jjccehkpthzv/insta-bot.sh && chmod 777 insta-bot.sh && ./insta-bot.sh"
msg -bar
 read -p " CONTINUAR"
}
...
echo -e "\033[0;35m[\033[0;36m12\033[0;35m] \033[0;34m<\033[0;33m + / - CREDITOS Por ID"
